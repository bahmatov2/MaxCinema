...
namespace MaxCinema.Controllers
{
    ...
    public class HallsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TotalRows,SeatsPerRow")] Hall hall)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TotalRows,SeatsPerRow")] Hall hall)
        {
            if (id != hall.Id)
            {
                return NotFound();
