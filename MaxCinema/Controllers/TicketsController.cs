...
namespace MaxCinema.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tickets.Include(t => t.Projection).Include(t => t.Seat).Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectionId,SeatId,UserId,PricePaid,PurchasedAt")] Ticket ticket)
        {
